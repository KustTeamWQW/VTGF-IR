...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='Irenhance', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='Irenhance', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
        ...
        parser.add_argument('--init_gain', type=float, default=0.06, help='scaling factor for normal, xavier and orthogonal.')
